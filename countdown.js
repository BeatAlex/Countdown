...
var countdown = document.getElementById("countdown"); // Where countdown will update
...
function countdown() {
    ...
    appender.parentNode.insertBefore(append, appender.nextSibling);
    append.id = "countdown";
    append.className += "ribbon block";
    ...
    window.setInterval(function() {
        ...
        var time_left = time_to_end.getTime() - now.getTime(),
        ...
        if (now >= holiday_start_date && now <= holiday_end_date) {
